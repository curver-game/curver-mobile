...
export type MessageToReceive = CreatedRoomMessage | JoinRoomErrorMessage | JoinedRoomMessage | LeftRoomMessage | LeaveRoomErrorMessage | UpdateMessage | SyncPathsMessage | GameEndedMessage | UserEliminatedMessage
